  ...
  const DelBtnModal = () => {
    return (
      <Modal
        title="删除"
        mask
        visible={IsDeleteVisiable}
        onOk={() => {
          setIsDeleteVisiable(false);
        }}
        onCancel={() => {
          setIsDeleteVisiable(false);
        }}
      ...
      },
      {
        ...
        render: (_, record) => {
          ...
          return editable ? (
            ...
            <Space size="middle">
              <Link to="/videos/monitorarea/1" activeClassName="active">
                修改监控区域
              </Link>
              |
              <Typography.Link
    ...
    const mergedColumns = columns.map((col) => {
      ...
      return {
        ...
        onCell: (record) => ({
          record,
          inputType:
            col.dataIndex === "interval" || col.dataIndex === "detect"
              ? "number"
              : "text",
